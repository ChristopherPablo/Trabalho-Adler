								...
								switch (item)
								{
									...
									case 1: // Venda
										...
										else
										{
											...
											TVsubTotal2.setText("Cálculo Subtotal!");
												...
												public void onClick(View v)
												{
												    ...
												    {  
												    	...
												    	{  
															...
															acoesLV.setQuantidade(quantidadestr);
															acoesLV.setSubTotal(TVsubTotal2.getText().toString());
									...
									case 2: // Aluguel
										...
										else
										{
											...
											TVsubTotal3.setText("Cálculo Subtotal!");
												...
												public void onClick(View v)
												{
												    ...
												    {  
												    	...
												    	{  
															...
															acoesLV.setQuantidade(quantidadestr);
															acoesLV.setSubTotal(TVsubTotal3.getText().toString());
